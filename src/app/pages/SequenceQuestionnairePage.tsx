...
import { QUESTIONS } from "../modules/sequence-questionnaire/questions";
import { STORAGE_KEYS } from "../modules/shared/storageKeys";
import { writeJson } from "../modules/shared/storage";

export default function SequenceQuestionnairePage() {
  ...
  const saveSequenceAndContinue = () => {
    writeJson(STORAGE_KEYS.sequence, {
        ...form,
